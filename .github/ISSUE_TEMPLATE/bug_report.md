...
- **No Actions:** `1.x.x` [e.g. 1.0.0 stable, commit hash]
<!-- Make sure to reproduce the issue with only CBA and No Actions on a newly created mission! -->

**Description:**
A clear and concise description of what the bug is.

**Steps to reproduce:**
_Follow [this flowchart](https://ace3.acemod.org/img/wiki/user/issue_flowchart.webp) (Replace 'ACE3' with 'No Actions', ignore any 'Slack' mentions)!_
